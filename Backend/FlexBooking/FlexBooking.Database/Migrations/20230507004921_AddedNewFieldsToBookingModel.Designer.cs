...
namespace FlexBooking.Domain.Migrations
{
    ...
    [Migration("20230507004921_AddedNewFieldsToBookingModel")]
    partial class AddedNewFieldsToBookingModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlexBooking.Domain.Models.BookingOffer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ArrivalDateUtc = new DateTime(2023, 5, 7, 6, 49, 20, 951, DateTimeKind.Utc).AddTicks(9706),
                            ...
                            DepartureDateUtc = new DateTime(2023, 5, 7, 0, 49, 20, 951, DateTimeKind.Utc).AddTicks(9705),
                        ...
                        {
                            Id = 2,
                            ArrivalDateUtc = new DateTime(2023, 5, 7, 6, 49, 20, 951, DateTimeKind.Utc).AddTicks(9714),
                            AvailablePassengerSeats = 100,
                            CompanyLogoUrl = "https://user-images.githubusercontent.com/44374504/230798095-0d48cfde-c2b1-4db8-b2ea-8d22b36a3b96.png",
                            DepartureDateUtc = new DateTime(2023, 5, 7, 0, 49, 20, 951, DateTimeKind.Utc).AddTicks(9714),
                        ...
                        {
                            Id = 3,
                            ArrivalDateUtc = new DateTime(2023, 5, 7, 6, 49, 20, 951, DateTimeKind.Utc).AddTicks(9716),
                            AvailablePassengerSeats = 100,
                            CompanyLogoUrl = "https://user-images.githubusercontent.com/44374504/230798095-0d48cfde-c2b1-4db8-b2ea-8d22b36a3b96.png",
                            DepartureDateUtc = new DateTime(2023, 5, 7, 0, 49, 20, 951, DateTimeKind.Utc).AddTicks(9716),
